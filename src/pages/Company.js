                ...
                <div className='tableMainBoxView tableDataHeight  '>
                  <div className='filterView '>
                    ...
                    <div className='filterBoxView'>
                      ...
                      <button type="button" className="btn mainBtn" onClick={() => setIsModalOpen(true)} ><span>Add New Company</span></button>
                    </div>
                  </div>
                  <div className=''>
                    <table  className="table">
                      <thead >
                        <tr className="bg-danger">
                          <th className="text-center " style={{ width: '150px' }} scope="col">S.no</th>
                                        ...
                                        {auth.admin ? null : (
                                          <>
                                            <Dropdown.Item className='tableMEnuTxt'
                                              onClick={() => { setUserEditData(item); setEditModalOpen(true); }}
                                            >
...
//                           <th className="text-center" scope="col">O.Id</th>
//                           <th style={{ width: '150px' }} className="text-center" scope="col">callbackUrl</th>
//                           <th className="text-center" scope="col">Comapny Name</th>
//                           <th className="text-center" scope="col">Status</th>
//                           <th className="text-center" scope="col">Email</th>
//                           <th className="text-center" scope="col">Username</th>
...
//                                 <th scope="row">{index + 1}</th>
//                                 {/* <td>{moment(item.date).format('DD/MM/YYYY')}</td> */}
//                                 <td style={{ width: '150px' }} className="text-center">{item.operatorId}</td>
//                                 <td style={{ width: '150px' }} className="text-center tableline">{item.callbackUrl}</td>
//                                 <td className="text-center">{item.companyName}</td>
//                                 <td className="text-center">{item.status}</td>
//                                 <td className="text-center">{item.email}</td>
//                                 <td className="text-center">{item.username}</td>
//                                 <td className="text-center">{item.reference}</td>
//                                 <td className="text-center"   >{`${item.companyShare} / ${item.totalSecurity}` }</td>
//                                 {/* <td>{item.email}</td> */}
//                                 {/* <td>{item.employees_name.length}</td> */}
