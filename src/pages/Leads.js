...
function Leads() {
  ...
  useEffect(() => {
    if (auth) {
      dispatch(fetchUsers("/leads/getallleads"));
    }
  ...
  return (
    <>
      <CreateLeads isModalOpen={isModalOpen} closeModal={closeModal} />
                ...
                <div className='tableMainBoxView tableDataHeight'>
                  <div className='filterView'>
                    ...
                    <div className='filterBoxView'>
                      ...
                      ><span>Add New Leads</span></button>
                    ...
                    <table className="table">
                      <thead>
                        <tr>
                          ...
                          <th scope="col">CreatedByType</th>
                          <th scope="col">Duration</th>

                          <th scope="col">Lead Name</th>
                          <th scope="col">Phone</th>
                          <th scope="col">Email</th>
                          <th scope="col">Leads Dec.</th>
                          <th scope="col"> </th>
                          {/* <th scope="col"></th> */}
                        </tr>
                      </thead>
